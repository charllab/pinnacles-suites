            ...
            <div class="container position-relative">
                ...
                <div class="row justify-content-center home-intro-cards">
                    <div class="col-md-6 col-xl-5 mb-5">
                        <div class="card">
                            <img class="card-img-top img-fluid" src="https://via.placeholder.com/495x295"
                                 alt="Card image cap">
                            <div class="card-body">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 offset-xl-1">
                        ...
                        <p>Stay up-to-date on the latest seasonal promotions and other news going on up at The Pinnacles
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-5 offset-lg-1">
                        <img src="https://via.placeholder.com/571x571" alt="" class="img-fluid mx-auto d-block mb-5 mb-lg-0">
                    </div>
        ...
        <section class="section">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 offset-lg-1 offset-xl-2 flex-lg-column align-self-lg-center">
