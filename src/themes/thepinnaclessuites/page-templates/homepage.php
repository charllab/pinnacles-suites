            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1 col-xl-5 offset-xl-1">
                        ...
                        <p class="text-white">Stay up-to-date on the latest seasonal promotions and other news going on
                            up at The Pinnacles
                            and Silver Star Mountain.</p>
                        <form>
                            <div class="input-group group-breaker mb-3">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8 offset-md-2 col-xl-5 offset-xl-1">
                        <img src="<?php bloginfo('template_url'); ?>/images/index-story-img-1.jpg" alt=""
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 offset-md-2 col-xl-5 justify-content-xl-end ml-xl-auto order-xl-1">
                        <img src="<?php bloginfo('template_url'); ?>/images/index-story-img-2.jpg" alt=""
                             class="img-fluid mx-auto d-block mb-5 mb-xl-0">
                    </div>
